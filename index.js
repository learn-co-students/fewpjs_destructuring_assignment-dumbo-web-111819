...
const noHorse = 'cow sheep pig chicken'
const [Bessie, Dolly, Babe, Little] = noHorse.split(' ')
...
const noChicken = 'cow sheep pig'
const [black_and_white, black, pink] = noChicken.split(' ')
// Arrays
